...
public class PrintfESCManager {
     ...
     * @param group
     */
    private void printfBitmaps(Bitmap bitmap, int left, int number,
...
//     * 当前方法，会造成阻塞
//     */
//    private void printfBitmap(Bitmap bitmap, int left, final PrintfResultCallBack printfResultCallBack){
//        bitmap = ImageUtil.convertGreyImgByFloyd(bitmap, context);
//        bluetoothManager.write(bitmap2PrinterBytes(bitmap,left));
//
//        PrintfInfoManager.getInstance(context).getPrinterPaperState(new PrintfInfoManager.GetPrinterCmdCallBack() {
//            @Override
//            public void getComplete() {
//                if (printfResultCallBack != null) {
//                    printfResultCallBack
//                            .callBack(PrintfResultCallBack.PRINTF_RESULT_SUCCESS);
//                }
//            }
//
//            @Override
...
//                if (printfResultCallBack != null) {
//                    printfResultCallBack
//                            .callBack(PrintfResultCallBack.PRINTF_RESULT_CMD_ERROR);
//                }
//            }
//        });
//
//    }
    ...
    public void printfTable(List<List<String>> datess,int effectiveWidth){
        ...
        int maxNumber = (int) (getCodeByteMaxNumber(currentCode) * effectiveWidth);
        for(int i = 0; i < datess.size(); i++){
            ...
            for(int j = 0; j < dates.size(); j++){
                ...
                try {
                    ...
                    int qianh = (int) ((col - length) / 2 * getCodeByteRelation(currentCode)) + 1;
